...
handler.before = async function (m) {
    ...
    let room = Object.values(this.game).find(room => room.id && room.game && room.state && room.id.startsWith('tictactoe') && [room.game.playerX, room.game.playerO].includes(m.sender) && room.state == '𝐏𝐥𝐚𝐲𝐢𝐧𝐠')
    if (room) {
        // m.reply(`[DEBUG]\n${parseInt(m.text)}`)
